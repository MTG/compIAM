...
class MridangamStrokeClassification:
    ...
    def train_model(self, model_type="svm", load_computed=True, balance=False, balance_ref="random"):
        ...
        if not os.path.exists(os.path.join(WORKDIR, "models", "timbre", \
        ...
        training_data, self.feature_list = process_strokes(self.dict_strokes(), load_computed=load_computed)
