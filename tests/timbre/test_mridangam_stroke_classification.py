...
def _predict_strokes():
    ...
    assert mridangam_stroke_class.list_strokes() == ['bheem', 'cha', 'dheem', 'dhin', 'num', 'ta', 'tha', 'tham', 'thi', 'thom']
    assert mridangam_stroke_class.dict_strokes() ==  {0: 'bheem', 1: 'cha', 2: 'dheem', 3: 'dhin', 4: 'num', 5: 'ta', 6: 'tha', 7: 'tham', 8: 'thi', 9: 'thom'}
